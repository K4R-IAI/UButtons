...
static struct FScriptStruct_VictoryBPLibrary_StaticRegisterNativesFVictorySubtitleCue
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FVictorySubtitleCue_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FVictorySubtitleCue_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FVictorySubtitleCue_Hash() { return 4088337979U; }
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AVictoryPC_OnVictorySubtitlesQueued_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVictoryPC, nullptr, "OnVictorySubtitlesQueued", sizeof(VictoryPC_eventOnVictorySubtitlesQueued_Parms), Z_Construct_UFunction_AVictoryPC_OnVictorySubtitlesQueued_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_OnVictorySubtitlesQueued_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08420800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AVictoryPC_OnVictorySubtitlesQueued_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_OnVictorySubtitlesQueued_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AVictoryPC_Subtitles_CPPDelegate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVictoryPC, nullptr, "Subtitles_CPPDelegate", sizeof(VictoryPC_eventSubtitles_CPPDelegate_Parms), Z_Construct_UFunction_AVictoryPC_Subtitles_CPPDelegate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_Subtitles_CPPDelegate_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AVictoryPC_Subtitles_CPPDelegate_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_Subtitles_CPPDelegate_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AVictoryPC_VictoryPC_GetMyIP_DataReceived_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVictoryPC, nullptr, "VictoryPC_GetMyIP_DataReceived", sizeof(VictoryPC_eventVictoryPC_GetMyIP_DataReceived_Parms), Z_Construct_UFunction_AVictoryPC_VictoryPC_GetMyIP_DataReceived_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_VictoryPC_GetMyIP_DataReceived_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AVictoryPC_VictoryPC_GetMyIP_DataReceived_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_VictoryPC_GetMyIP_DataReceived_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AVictoryPC_VictoryPlaySpeechSound_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVictoryPC, nullptr, "VictoryPlaySpeechSound", sizeof(VictoryPC_eventVictoryPlaySpeechSound_Parms), Z_Construct_UFunction_AVictoryPC_VictoryPlaySpeechSound_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_VictoryPlaySpeechSound_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020409, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AVictoryPC_VictoryPlaySpeechSound_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AVictoryPC_VictoryPlaySpeechSound_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AVictoryPC_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVictoryPC_OnVictorySubtitlesQueued, "OnVictorySubtitlesQueued" }, // 2853519523
		{ &Z_Construct_UFunction_AVictoryPC_Subtitles_CPPDelegate, "Subtitles_CPPDelegate" }, // 2886273150
		{ &Z_Construct_UFunction_AVictoryPC_VictoryPC_GetMyIP_DataReceived, "VictoryPC_GetMyIP_DataReceived" }, // 125827401
		{ &Z_Construct_UFunction_AVictoryPC_VictoryPC_GetMyIP_SendRequest, "VictoryPC_GetMyIP_SendRequest" }, // 937354891
		{ &Z_Construct_UFunction_AVictoryPC_VictoryPlaySpeechSound, "VictoryPlaySpeechSound" }, // 1034661531
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AVictoryPC, 820109840);
